...
class StatsManager:
    ...
    def record_session(
        ...
        Args:
            ...
            check_ins (int): verified mobile daily check-ins this run.
            read_articles (int): mobile Read to Earn articles credited this run.
            read_points (int): actual points credited by Read to Earn.
            mobile_task_runs (int): number of mobile task orchestration passes.
        ...
        lifetime["check_ins"] = lifetime.get("check_ins", 0) + checkin
        lifetime["read_articles"] = lifetime.get("read_articles", 0) + articles
        lifetime["read_points"] = lifetime.get("read_points", 0) + read_credit
        lifetime["mobile_task_runs"] = lifetime.get("mobile_task_runs", 0) + mobile_runs
        lifetime["runs"] += 1
        ...
        stats["last_session"] = {
            ...
            "read_points": read_credit,
            "mobile_task_runs": mobile_runs,
        ...
        bucket["check_ins"] = bucket.get("check_ins", 0) + checkin
        bucket["read_articles"] = bucket.get("read_articles", 0) + articles
        bucket["read_points"] = bucket.get("read_points", 0) + read_credit
        bucket["mobile_task_runs"] = bucket.get("mobile_task_runs", 0) + mobile_runs
        bucket["runs"] += 1
